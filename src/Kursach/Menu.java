...
public class Menu {
    ...
    void textMainMenu() {
        ...
        System.out.println(ITALIC_START + "  2. Генерация CSV файла со случайными e-mail." + ITALIC_END);
    ...
    void requestDataAndFileCSVTableGeneration() {
        ...
        System.out.print("""
                Далее Вам необходимо будет выбрать в какие столбцы будут генерироваться данные
                 0-данный столбец не нужно генерировать
                 1-генерировать
                """);
